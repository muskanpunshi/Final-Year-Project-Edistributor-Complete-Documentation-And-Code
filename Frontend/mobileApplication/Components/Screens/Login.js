...
const Login = ({ navigation }) => {
  ...
  const userLogin = () => {
    ...
    Axios.post('http://10.0.2.2:5050/login',
      {
        email: email,
        password: password
      })
  ...
  return (
    ...
    <KeyboardAwareScrollView >
      ...
      <View style={{ flex: 0.65, borderBottomLeftRadius: 30, borderBottomRightRadius: 30, zIndex: 1, marginTop: 30, padding: 15 }}>
        <View style={{ flex: 1, }}>
          <View style={{ marginBottom: -100, flex: 0.95, borderRadius: 25, padding: 20, margin: 15, shadowColor: 'black', shadowOpacity: 0.26, shadowOffset: { width: 0, height: 2 }, shadowRadius: 10, elevation: 3, backgroundColor: 'white' }}>
            ...
            <View style={{ flex: 0.7, justifyContent: 'center', alignContent: 'center', marginTop: 20 }}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'flex-end' }}>
                <TouchableOpacity>
                  <View style={{ margin: 8, marginRight: 22 }} >
                    <Text style={{ color: '#4682B4' }}>Forgot Password?</Text>
                  </View>
                </TouchableOpacity>
              </View>
            ...
            <View style={{ flex: 0.3, justifyContent: 'center', alignItems: 'center', alignContent: 'center' }}>
              <View style={{ margin: 30, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', alignContent: 'center' }} >
                <Text>
