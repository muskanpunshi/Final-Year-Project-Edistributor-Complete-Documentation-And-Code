...
import { Text, View, TouchableOpacity, ActivityIndicator, FlatList,Image ,StatusBar} from 'react-native';
import Axios from 'axios';
import Icon from 'react-native-vector-icons/Feather'

const Bakeline = ({ navigation }) => {
            ...
            <FlatList
                ...
                renderItem={({ item, index }) =>
                    <TouchableOpacity
                        ...
                        style={{ flex: 1, backgroundColor: '#ffff', height: 200, borderRadius: 5, margin: 5 }}>
